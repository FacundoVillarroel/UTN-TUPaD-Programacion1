...
# radio como parámetro y devuelva el área del círculo. calcular_perimetro_circulo(radio) 
...
def calcular_area_circulo(radio): # formula de área π * r^2
    import math
    return math.pi * radio ** 2

def calcular_perimetro_circulo(radio): # formula de perímetro 2 * π * r
    import math
...
print(f"Área del círculo: {round ( area, 2) }") # redondeo a 2 decimales 
print(f"Perímetro del círculo: {round ( perimetro, 2) }") # redondeo a 2 decimales 
...
def calcular_imc(peso, altura): # formula IMC = peso / altura^2
...
def celsius_a_fahrenheit(celsius): # formula F = C * 9/5 + 32
